  ...
  return (
    <MDBFooter bgColor="dark" className="text-center text-lg-start text-muted">
      <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        {/* iconos redes an color . Pendiente */}
        {/* <div>
          <span class="social-media-buttons">
            <span class="social-media-button">
              <a href="https://www.instagram.com/favorit.gastrobar/?igshid=YmMyMTA2M2Y%3D">
                <img alt="Instagram" src={instagram} />
              </a>
            </span>
            <span class="social-media-button">
            <a href="https://www.instagram.com/favorit.gastrobar/?igshid=YmMyMTA2M2Y%3D">
                <img alt="Instagram" src={facebook} className="socials-facebook"/>
              </a>
            </span>
            <span class="social-media-button">
              <img alt="Youtube" src={twitter} />
            </span>
            <span class="social-media-button">
        ...
        {/*  end iconos redes an color . Pendiente */}
        <div>
          <a
          ...
          <a href="https://google.es" className="me-4 text-reset">
        ...
        <MDBContainer className="text-center text-md-start mt-5">
          <MDBRow className="mt-3">
            ...
            <MDBCol md="4" lg="4" xl="6" className="mx-auto mb-4">
              ...
              <p>
                <FormattedMessage id="app.lunes" />:{" "}
                <FormattedMessage id="app.closed" />
              </p>
              <p>
                <FormattedMessage id="app.martesJueves" />
                :&nbsp;11:00-17:00&nbsp;
                <FormattedMessage id="app.y" />
                &nbsp;19:00&nbsp;
                <FormattedMessage id="app.cierre" />
              </p>
              <p>
                <FormattedMessage id="app.viernesDomingo" />: 12:00&nbsp;
                <FormattedMessage id="app.cierre" />
              </p>
